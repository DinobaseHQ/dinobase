...
def get_host() -> str:
    return os.environ.get("DINOBASE_OAUTH_HOST", "0.0.0.0")


def get_port() -> int:
    return int(os.environ.get("DINOBASE_OAUTH_PORT", "8787"))


def get_base_url() -> str:
    """The public-facing URL of this proxy (used for OAuth redirect_uri)."""
    return os.environ.get(
        "DINOBASE_OAUTH_BASE_URL",

...
This is the same MCP server used by [Claude Desktop](/integrations/claude-desktop/) and [Vercel AI SDK](/integrations/vercel-ai/) — same tools, same data, different framework.

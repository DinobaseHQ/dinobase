...
This is the same interface used by Claude Code, Aider, and other shell-capable agents. The data and query engine are identical to the [MCP server](/integrations/mcp/) -- just a different transport.

...
Cloud storage connectors use dlt's filesystem connector to sync files incrementally. Unlike [file connectors](files.md) which read at query time, these copy data locally and support incremental loading.

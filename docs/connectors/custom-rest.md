...
- [CLI reference for `connector create`](../reference/cli.md#dinobase-connector-create-name) — all flags
- [MCP server connectors](mcp.md) — for MCP-based tools instead of REST APIs

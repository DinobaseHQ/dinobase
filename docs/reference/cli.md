...
With `--storage`, data is stored in cloud storage instead of locally. See the [Cloud Storage Backend](../guides/cloud-storage-backend.md) guide.
...
Creates `~/.dinobase/connectors/<name>.yaml`. See [Custom REST Connectors](../connectors/custom-rest.md) and [MCP Server Connectors](../connectors/mcp.md).

...
See [SaaS APIs reference](../connectors/saas.md) for all supported services.
...
See [Databases reference](../connectors/databases.md) for all supported databases.
...
See [Files reference](../connectors/files.md) for more details.
...
See the full [Custom REST Connectors reference](../connectors/custom-rest.md) for the YAML format, auth types, fetch modes, and connector management commands.
...
See the full [MCP Server Connectors reference](../connectors/mcp.md) for the YAML format, tool-selection rules, and direct tool-call examples (CLI + Python).
